...
public class PDFCreate2Table {  
    ...
    public static void main(String[] args) {  
        ...
        boolean result1 = pdfCreate2Table.createNormalTable("21表格正常内容文档.pdf", 500);
        long endTime1 = System.currentTimeMillis();  
        System.out.println("表格正常内容的pdf文档创建结果：" + result1+"。总计花费时间:"+((endTime1-startTime1)/1000)+"秒");  
        System.out.println("--------------------------------------------------------------------------");  
        long startTime2 = System.currentTimeMillis();  
        boolean result2 = pdfCreate2Table.createRowTooMuchTable("22表格行信息超长文档.pdf", 500000,2000);
        long endTime2 = System.currentTimeMillis();  
        System.out.println("表格行信息超长的pdf文档创建结果：" + result2+"。总计花费时间:"+((endTime2-startTime2)/1000)+"秒");  
        System.out.println("--------------------------------------------------------------------------");  
        long startTime3 = System.currentTimeMillis();  
        boolean result3 = pdfCreate2Table.createColumnTooMuchTable("23表格列信息超长文档.pdf", 5000);
        long endTime3 = System.currentTimeMillis();  
        System.out.println("表格行信息超长的pdf文档创建结果：" + result3+"。总计花费时间:"+((endTime3-startTime3)/1000)+"秒");  
        System.out.println("--------------------------------------------------------------------------");  
        long startTime4 = System.currentTimeMillis();  
        boolean result4 = pdfCreate2Table.createRowTooMuchTable("24表格行列都信息超长文档.pdf", 200000,2000);
